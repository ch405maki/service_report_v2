        ...
        <div class="py-12">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                    <tr v-for="report in reports" :key="report.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
...
// Define a reactive variable to store reports
const reports = ref([]);
...
async function fetchServiceReports() {
        try {
            ...
            const token = '3|UisIuauGCww8dMbYduBY8yDeE6fkTdE3l11S4tPh3f616ba3';
